...
interface EncounterTableFormAttrs {
    onSubmit(obj: TableObject): void;
    onCancel(): void;
}

function EncounterTableForm ({onSubmit, onCancel}: EncounterTableFormAttrs) {
    ...
    function generateTableObject (): TableObject {
        return {
            title: titleValue,
            dice: diceValue,
            entries
    ...
    function onSaveTable (): void {
        const obj = generateTableObject();
        onSubmit(obj);
    }
        ...
        <div>
            ...
            <div className="etf-form">
                ...
                <div className="sd-control-row">
                    ...
                    {
                        errorList.filter(e => e.show === true).length === 0 &&
